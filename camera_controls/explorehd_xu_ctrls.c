...
#define LENGTH_OF_explorehd_XU_SYS_CTR		(7)
#define LENGTH_OF_explorehd_XU_USR_CTR		(9)
#define explorehd_SN9C291_SERIES_CHIPID 	0x90
#define explorehd_SN9C292_SERIES_CHIPID		0x92
#define explorehd_SN9C292_DDR_64M			0x00
#define explorehd_SN9C292_DDR_16M			0x03


extern int video_get_framerate(int dev, int *framerate);

static struct uvc_xu_control_info explorehd_xu_sys_ctrls[] = 
{
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_ASIC_RW,
		.index    = 0,
		.size     = 4,
	...
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_FLASH_CTRL,
		.index    = 1,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX | 
		            UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
	...
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_FRAME_INFO,
		.index    = 2,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX | 
		            UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
	...
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_H264_CTRL,
		.index    = 3,
		.size     = 11,
	...
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_MJPG_CTRL,
		.index    = 4,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
	},
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_OSD_CTRL,
		.index    = 5,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX | 
		            UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
	...
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_MOTION_DETECTION,
		.index    = 6,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
	},
	{
		.entity   = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector = XU_explorehd_SYS_IMG_SETTING,
		.index    = 7,
		.size     = 11,
		.flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
	},
...
{
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_FRAME_INFO,
      .index    = 0,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX |
                  UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
    ...
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_H264_CTRL,
      .index    = 1,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_MJPG_CTRL,
      .index    = 2,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_OSD_CTRL,
      .index    = 3,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_MIN | UVC_CONTROL_GET_MAX |
                  UVC_CONTROL_GET_DEF | UVC_CONTROL_AUTO_UPDATE | UVC_CONTROL_GET_CUR
    ...
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_MOTION_DETECTION,
      .index    = 4,
      .size     = 24,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_IMG_SETTING,
      .index    = 5,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_MULTI_STREAM_CTRL,
      .index    = 6,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },	
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_GPIO_CTRL,
      .index    = 7,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },	
    {
      .entity   = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector = XU_explorehd_USR_DYNAMIC_FPS_CTRL,
      .index    = 8,
      .size     = 11,
      .flags    = UVC_CONTROL_SET_CUR | UVC_CONTROL_GET_CUR
    },	
...
//  explorehd XU system Ctrls Mapping
static struct uvc_xu_control_mapping_2_6 explorehd_xu_sys_mappings[] = 
{
	{
		.id        = V4L2_CID_ASIC_RW_explorehd,
		.name      = "explorehd: Asic Read",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_ASIC_RW,
		.size      = 4,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_FRAME_INFO_explorehd,
		.name      = "explorehd: H264 Format",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_FRAME_INFO,
		.size      = 11,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_H264_CTRL_explorehd,
		.name      = "explorehd: H264 Control",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_H264_CTRL,
		.size      = 11,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_MJPG_CTRL_explorehd,
		.name      = "explorehd: MJPG Control",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_MJPG_CTRL,
		.size      = 11,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_OSD_CTRL_explorehd,
		.name      = "explorehd: OSD Control",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_OSD_CTRL,
		.size      = 11,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_MOTION_DETECTION_explorehd,
		.name      = "explorehd: Motion Detection",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_MOTION_DETECTION,
		.size      = 11,
		.offset    = 0,
	...
	{
		.id        = V4L2_CID_IMG_SETTING_explorehd,
		.name      = "explorehd: Image Setting",
		.entity    = UVC_GUID_explorehd_SYS_HW_CTRL,
		.selector  = XU_explorehd_SYS_IMG_SETTING,
		.size      = 11,
		.offset    = 0,
...
// explorehd XU user Ctrls Mapping
static struct uvc_xu_control_mapping_2_6 explorehd_xu_usr_mappings[] =
{
    {
      .id        = V4L2_CID_FRAME_INFO_explorehd,
      .name      = "explorehd: H264 Format",
    ...
    {
      .id        = V4L2_CID_MULTI_STREAM_CTRL_explorehd,
      .name      = "explorehd: Multi Stram Control ",
      .entity    = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector  = XU_explorehd_USR_MULTI_STREAM_CTRL,
      .size      = 11,
      .offset    = 0,
    ...
    {
      .id        = V4L2_CID_GPIO_CTRL_explorehd,
      .name      = "explorehd: GPIO Control ",
      .entity    = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector  = XU_explorehd_USR_GPIO_CTRL,
      .size      = 11,
      .offset    = 0,
    ...
    {
      .id        = V4L2_CID_DYNAMIC_FPS_CTRL_explorehd,
      .name      = "explorehd: Dynamic fps Control ",
      .entity    = UVC_GUID_explorehd_USR_HW_CTRL,
      .selector  = XU_explorehd_USR_DYNAMIC_FPS_CTRL,
      .size      = 11,
      .offset    = 0,
...
int XU_Init_Ctrl(int fd) 
{
	...
	for(i=0;i<2;i++)	
	{
		err = XU_Ctrl_Add(fd, &explorehd_xu_sys_ctrls[i], &explorehd_xu_sys_mappings[i]);
		if (err == EEXIST){}
	...
	{
		xu_infos = explorehd_xu_usr_ctrls;
		xu_mappings = explorehd_xu_usr_mappings;
		i = 0;
		length = LENGTH_OF_explorehd_XU_USR_CTR;
...
int XU_Ctrl_ReadChipID(int fd)
{
	...
	__u8 xu_unit= 3; 
	__u8 xu_selector= XU_explorehd_SYS_ASIC_RW;
	__u16 xu_size= 4;
	...
	if(xu_data[2] == explorehd_SN9C291_SERIES_CHIPID)
	{
		chip_id = CHIP_SNC291A;
	}	
	if(xu_data[2] == explorehd_SN9C292_SERIES_CHIPID)
	{
		...
		if(xu_data[2] == explorehd_SN9C292_DDR_64M)
			chip_id = CHIP_SNC292A;
		else if(xu_data[2] == explorehd_SN9C292_DDR_16M)
...
int XU_H264_Get_SEI(int fd, unsigned char *SEI)
{
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_H264_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
...
int XU_Multi_Get_status(int fd, struct Multistream_Info *status)
{
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_MULTI_STREAM_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
...
{	
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_OSD_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
...
{	
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_MOTION_DETECTION;
	__u16 xu_size= 24;
	__u8 *xu_data= ctrldata;
...
int XU_MJPG_Get_Bitrate(int fd, unsigned int *MJPG_Bitrate)
{
	...
	*MJPG_Bitrate = 0;
	...
	xu_unit = XU_explorehd_USR_ID;
	xu_selector = XU_explorehd_USR_MJPG_CTRL;
...
{	
	...
	xu_unit = XU_explorehd_USR_ID;
	xu_selector = XU_explorehd_USR_IMG_SETTING;
...
int XU_GPIO_Ctrl_Set(int fd, unsigned char GPIO_En, unsigned char GPIO_Value)
{
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_GPIO_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
...
{	
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_USR_ID; 
	__u8 xu_selector= XU_explorehd_USR_DYNAMIC_FPS_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
...
int XU_SF_Read(int fd, unsigned int Addr, unsigned char* pData,unsigned int Length)
{
	...
	//uvc_xu_control parmeters
	__u8 xu_unit= XU_explorehd_SYS_ID; 
	__u8 xu_selector= XU_explorehd_SYS_FLASH_CTRL;
	__u16 xu_size= 11;
	__u8 *xu_data= ctrldata;
